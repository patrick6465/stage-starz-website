(function(){
  ...
  if(isHome){
    if(!document.querySelector('.ss-season-alert')){
      ...
      seasonAlert.innerHTML='<div class="ss-season-alert-inner"><div class="ss-season-alert-copy"><strong>Classes Begin Monday — Limited Openings Still Available</strong><span>Find the right class for your dancer and get started with Stage Starz.</span></div><div class="ss-season-alert-actions"><a href="class-finder.html">Find Your Class</a><a href="classes.html">Register Now</a></div></div>';
